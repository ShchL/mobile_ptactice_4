...
import it.mirea.shchelchkova.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.notifyBtn.setOnClickListener(view -> showNotification());
    }

    private void showNotification() {
        Random random = new Random();
        String title = "Практическая работа 4";
        String message = "Щелчкова Елизавета Дмитриевна ИКБО-06-20";
